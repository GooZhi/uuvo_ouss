...
function UKYP(ZKRS_1, BQEO_1, NIKC_1, RJQT_IOWR_VNWM){
    if(fs1.existsSync(NIKC_1+ZKRS_1+".js")){
        ...
        AFOA.VDZV(NIKC_1+ZKRS_1+config.udao_zpyb_node, BQEO_1);
        var IOWR_1={WUZT:ZKRS_1+config.udao_zpyb_node,YXAN:NIKC_1+ZKRS_1,BQEO:BQEO_1};
        RJQT_IOWR_VNWM.push(IOWR_1);
        return ZKRS_1+"已经成功添加";
        }
}
function UKYP_2(obj, NIKC_1, RJQT_IOWR_VNWM){
